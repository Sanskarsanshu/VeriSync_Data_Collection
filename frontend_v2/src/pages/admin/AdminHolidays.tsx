...
const getBadgeStyles = (type: string) => {
  switch (type) {
    ...
    case 'INSTITUTIONAL': return 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20';
    ...
    <DashboardLayout role="admin">
      <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-yellow-500/10 text-yellow-600 text-xs font-semibold mb-3 border border-yellow-500/20">
              <Palmtree size={14} /> Schedule
            </div>
            <h1 className="text-3xl font-bold tracking-tight text-foreground">Holidays & Breaks</h1>
            <p className="text-muted-foreground mt-1">Configure non-working days where attendance tracking is disabled.</p>
          </div>
          
          <Button className="bg-yellow-500 hover:bg-yellow-600 text-white shadow-lg shadow-yellow-500/20 gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
          ...
          <div className="col-span-1 space-y-6">
            <div className="bg-card border border-border rounded-2xl p-6 shadow-sm h-fit text-center space-y-4 sticky top-6">
               <CalendarIcon className="size-10 mx-auto text-yellow-500" />
               ...
               <div className="pt-4 border-t border-border/50">
                 ...
                 <div className="flex justify-between text-sm">
                   ...
                   <span className="font-bold text-yellow-600">{upcomingHolidays.length}</span>
                 </div>
               </div>
            </div>
          </div>
          ...
          <div className="md:col-span-3 flex flex-col gap-8">
            ...
            <section>
              <div className="flex items-center gap-2 mb-4">
                <CalendarCheck2 className="text-yellow-500" size={20} />
