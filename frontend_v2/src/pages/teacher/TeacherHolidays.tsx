...
const getBadgeStyles = (type: string) => {
  switch (type) {
    case 'NATIONAL': return 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20';
    ...
    case 'INSTITUTIONAL': return 'bg-teal-500/10 text-teal-500 border-teal-500/20';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
          ...
          <div className="col-span-1 space-y-6">
            <div className="bg-card border border-border rounded-2xl p-6 shadow-sm h-fit text-center space-y-4 sticky top-6">
               <CalendarIcon className="size-10 mx-auto text-emerald-500" />
               ...
               <div className="pt-4 border-t border-border/50">
                 ...
                 <div className="flex justify-between text-sm">
                   ...
                   <span className="font-bold text-emerald-600">{upcomingHolidays.length}</span>
                 </div>
               </div>
            </div>
          </div>
