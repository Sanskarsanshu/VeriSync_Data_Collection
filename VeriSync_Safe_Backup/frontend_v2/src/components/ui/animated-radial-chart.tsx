    ...
    >
      ...
      >
        ...
        <motion.line
          x1={useTransform(
            progressAngle,
            (angle) => center + Math.cos(angle) * innerRadius,
          )}
          y1={useTransform(
            progressAngle,
            (angle) => center + Math.sin(angle) * innerRadius,
          )}
          x2={useTransform(
            progressAngle,
            (angle) =>
              center + Math.cos(angle) * innerRadius - Math.cos(angle) * 30,
          )}
          y2={useTransform(
            progressAngle,
            (angle) =>
              center + Math.sin(angle) * innerRadius - Math.sin(angle) * 30,
          )}
